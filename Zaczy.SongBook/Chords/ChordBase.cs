...
public class ChordBase
{
    ...
    /// <param name="mutedStrings"></param>
    /// <param name="openStrings"></param>
    public ChordBase(string? name, HashSet<int>? mutedStrings, HashSet<int>? openStrings)
    {
        Name = name;
    ...
    /// </summary>
    protected int GetStartFret(int fretCount)
    {
    ...
    public string ToAscii(int fretCount = 4)
    {
        ...
        int crossbarMaxString = _stringCount;
        ...
        for (int stringNum = 1; stringNum <= _stringCount; stringNum++)
        {
    ...
    public string ToAsciiVertical(int fretCount = 4)
    {
        ...
        sb.Append("  ");
        for (int stringNum = _stringCount; stringNum >= 1; stringNum--)
        {
            if (MutedStrings.Contains(stringNum))
                sb.Append("x ");
            else if (OpenStrings.Contains(stringNum))
    ...
    public string ToSvg(int width = 80, int height = 100)
    {
        ...
        int stringSpacing = gridWidth / (_stringCount - 1); // 6 strun = 5 odstępów
        ...
        if (crossbar != null)
        {
            ...
            {
                minString = 1;
                maxString = _stringCount;
            }

            int x1 = marginLeft + (_stringCount - maxString) * stringSpacing;
            int x2 = marginLeft + (_stringCount - minString) * stringSpacing;
    ...
    public string ToSvgHorizontal(int width = 100, int height = 80, string? drawColor = null)
    {
        ...
        int stringSpacing = gridHeight / (_stringCount - 1); // 6 strun = 5 odstępów
        int circleRadius = 6;
