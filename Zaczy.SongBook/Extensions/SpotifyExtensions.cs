...
public static class SpotifyExtensions
{
    ...
    /// <summary>
    /// Nazwa artysty lub tytu³ piosenki, przetworzona do formy "czystej" (bez znaków interpunkcyjnych, spacji i wielkoœci liter) do porównañ tekstowych.
    /// </summary>
    /// <param name="text"></param>
    /// <returns></returns>
    public static string ValueForComparisions(this string? text)
    {
